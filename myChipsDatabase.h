...
const char CHIP_EMPTY[] PROGMEM = ("EMPTY:Empty ZIF"  \
                    ":ZZZZZZZZZZ/ZZZZZZZZZZ:Empty");

const char CHIP_x74245[] PROGMEM = ("74245:Transceiver 8 bit" \
...
const char CHIP_x74242[] PROGMEM = ("74242:Transceiver Inverting 4 bit"  \
...
const char CHIP_x74173[] PROGMEM = ("74173:4-bit 3-state D flip-flop with reset, dual clock enables and dual output enables" \
